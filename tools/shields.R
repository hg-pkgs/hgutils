...
add_shields = function() {
  ...
  version = paste0("[![Package version](https://img.shields.io/badge/version-v",desc$Version,"-",ifelse(is_dev,"lightgrey","blue"),".svg)](https://github.com/hvdboorn/hgutils/blob/master/README.Rmd)")
  ...
  last_update = paste0("[![last_update](https://img.shields.io/badge/last%20update-",
                       format(Sys.Date(), dformat) %>% str_replace_all("-","--"),"-orange.svg)](https://github.com/hvdboorn/hgutils/commits/master)")
